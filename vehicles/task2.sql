-- Задача 2: Найти производителей и модели транспортных средств
-- по заданным критериям (авто, мото, велосипеды) с сортировкой по мощности
...
-- Велосипеды
SELECT v.maker, v.model, NULL AS horsepower, NULL AS engine_capacity, 'Bicycle' AS type
FROM Vehicle v
